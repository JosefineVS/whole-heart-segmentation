...
#x_val, y_val = create_data(filelist_val,filelist_val_label,'sag')
...
#     Save the model in the end
    saver.save(sess,"WHS/Results/region/model_sag/model.ckpt")
    np.save('WHS/Results/train_hist/region/train_loss_sag',train_loss)
    np.save('WHS/Results/train_hist/region/train_acc_sag',train_accuracy)
#    np.save('WHS/Results/train_hist/region/valid_loss_sag',valid_loss)
#    np.save('WHS/Results/train_hist/region/valid_acc_sag',valid_accuracy)
